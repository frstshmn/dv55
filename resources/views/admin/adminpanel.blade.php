                        ...
                        <div class="col-12 my-5">
                            <div class="neuro-card text-center p-5 row">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="neuro-card py-3 my-3 d-flex flex-row justify-content-around align-items-center">
                                        {{$module->title}}
                                        <div class="dropdown">
                                            <button class="button dropdown-toggle py-2" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                              Actions
                                            </button>
                                ...
                                <div class="col-4">
                                    <p class="font-weight-bold text-center">Materials of %modulename%</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
